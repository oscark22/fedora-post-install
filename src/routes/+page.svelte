...
<div class="font-sans antialiased text-slate-800">
	<div class="px-4">
		<nav class="flex bg-slate-100 py-3 justify-end">
		...
		<div class="flex flex-col">
			...
			<p class="leading-relaxed">
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima accusantium, recusandae dolorum ipsum animi molestias quaerat eaque suscipit explicabo, quasi consectetur. Deserunt quam dolorum atque, eum placeat in eligendi quasi.
			</p>
		</div>
	</div>
</div>
